...
// Handles the running of the Note maxVelocity2or so the driver doesn't have to
...
public class SmartMaxVelocity2Command extends Command {
  ...
  // private LoggedDashboardNumber maxVelocity2VoltsInput = new LoggedDashboardNumber("MaxVelocity2
  // Volts",
  // 4.0);
  ...
  // Run the conveyor at normal maxVelocity2 speed to accept a Note from the intake
